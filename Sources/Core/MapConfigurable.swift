...
public struct WMSConfig: MapConfigurable {
    ...
    public init(baseUrl: String, version: String = "1.3.0", requestType: String, format: String = "image/png", minZoom: Int = 7, maxZoom: Int = 19, initialZoom: Int = 7, tileSize: Double = 256.0, corner: MapExtent.Corner = .topLeft, parameters: [String:Any] = [:]) {
